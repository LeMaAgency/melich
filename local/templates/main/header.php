...
<header>
    ...
    <div class="core__menu-nav__mobile__alert">
        ...
        <div class="core__menu-nav__mobile__alert__menu"
             data-core-name="<?= Loc::getMessage('LEMA_HEADER_MENU_TITLE'); ?>" data-js-core-resize-after="menu">
        </div>
    </div>
        ...
        <div class="mob-menu">
            ...
            <div class="mob-menu-footer">
                <div class="header__main__phone__btn">
                    <a href="tel:89282656333" title="Позвонить" class="header__main__phone__btn__control">Позвонить
                        нам</a>
                </div>
            </div>
