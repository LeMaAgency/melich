                        ...
                        <div class="about-content__wrap">
                            <ul class="about-list">
                                <li class="about-list__item">
                                    <p>Фабрика разрабатывает и изготавливает авторскую, эксклюзивную одежду из натурального меха овчины (мутон) премиум класса, астрагана, каракуля, норки, бобра, соболя, кожаных и замшевых изделий, дубленок высочайшего
                                        качества</p>
                                </li>
                                <li class="about-list__item">
                                    <p>Наш опыт и мастерство, внимание к каждой детали, использование только лучших мехов и кожи, являются гарантом качества наших изделий. Меховые изделия бренда «MELICH» - это синоним качества и правильной цены.</p>
                                </li>
                                <li class="about-list__item">
                                    <p>Стараемся развиваться не только сохраняя свое высокое качество, но и улучшая его.</p>
                                </li>
                            </ul>
                            <ul class="about-list">
                                <li class="about-list__item">
                                    <p>Шубы Компании «MELICH» – это женственный, элегантный силуэт, стильные шубы на каждый день, эксклюзивные меховые изделия для особого выхода, разнообразная палитра меха, а также цветовая гамма, которая не оставит
                                        равнодушных самых избалованных меховых гурманов.</p>
                                </li>
                                <li class="about-list__item">
                                    <p>Мы уделяем особое внимание соблюдению международных стандартов по защите животных, покупая только качественное сырье у сертифицированных поставщиков на мировых аукционах.</p>
                                </li>
                                <li class="about-list__item">
                                    <p>При создании нашей очередной коллекции, мы учитываем все тенденции моды, которые идеально сочетаются с инновациями и современным стилем</p>
                                </li>
                            </ul>
                        </div>
                    </div>
